    ...
    internal sealed class EnemyPool
    {
        ...
        public Enemy GetEnemy(string type)
        {
            ...
            switch (type)
            {
                case "Asteroid":
                    ...
                    break;
                default: throw new ArgumentOutOfRangeException(nameof(type), type, "Не предусмотрен в программе");
            }
            return result;
        }
        ...
        private Enemy GetAsteroid(HashSet<Enemy> enemies)
        {
            ...
            if (enemy == null)
            {
                ...
                {
                    var instatiate = Object.Instantiate(laser);
                    ReturnToPool(instatiate.transform);
                    enemies.Add(instatiate);  
                }
                GetAsteroid(enemies);
            }
